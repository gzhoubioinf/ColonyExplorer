...
def render_strain_overview(r) -> None:
    ...
    st.html('<div class="cv-section-title">Strain Overview</div>')
...
def render_resistance(r) -> None:
    ...
    st.html('<div class="cv-section-title">Key Resistance Determinants</div>')

    st.html('<div class="cv-subsection-title">Acquired resistance genes</div>')
    acq_parts: list[str] = []
    ...
    st.write("")
    st.html('<div class="cv-subsection-title">Resistance mutations</div>')
    mut_parts: list[str] = []
...
def render_virulence(r) -> None:
    ...
    st.html('<div class="cv-section-title">Virulence Profile</div>')
...
def render_detailed_tables(r) -> None:
    ...
    st.html('<div class="cv-section-title">Detailed Gene Tables</div>')
